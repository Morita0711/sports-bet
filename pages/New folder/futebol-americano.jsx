...
const americanfootball = ({ featuredPosts, posts, tags, allUserTweets }) => {
  ...
  //console.log(currentSportEvent);
  //   useEffect(() => {
  //     if (!isLoading) {
  //       console.log(Object.values(events?.events)[0]);
  //       setCurrentSportEvent(Object.values(events?.events)[0]);
  //     }
  //   }, [isLoading]);
  ...
  return (
    <>
      <Head>
        <title> American football | Bets</title>
      </Head>
      <Header />
      ...
      <SoccerLeagues
        sportName="futebol americano"
        id="Futebol_Americano"
        url="https://proxy.bets.com.br/americanfootball/trial/v2/pt/competitions.json?api_key=xnudbqdneze5vkhvgygvcvtk"
        activeCont={{
